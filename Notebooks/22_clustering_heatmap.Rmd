...
tse_gbm_count <- readRDS(here("Data/Processed/tse_gbm_count.rds"))
tse_l6_count <- readRDS(here("Data/Processed/tse_l6_count.rds"))
...
taxa_ann <- data.frame(
  ...
  Phylum = c(rep("Bacillota", 4), rep("Bacteroidota", 4), "Actinobacteria", rep("Bacillota", 3), "Desulfobacterota")
)
...
png(here("Plots/beta_heatmap.png"), width = 2400, height =1800, res = 300)
...
Heatmap(
  ...
  right_annotation = rowAnnotation(
    ...
    col = list(
      ...
      Phylum = c("Bacillota"   = "#7CCD7C", "Bacteroidota" = "#FFA54F", "Actinobacteria" = "#EE3B3B", "Desulfobacterota" = "#EE799F")),
    width = unit(4, "mm"),
