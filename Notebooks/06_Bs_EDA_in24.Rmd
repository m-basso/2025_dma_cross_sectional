...
```{r - data }
in24_ni_t1.adj.lm <- readRDS(here("Data/processed/in24_ni_t1.adj.lm.rds"))
...
in24_fi_t1.adj.cat <- readRDS(here("Data/processed/in24_fi_t1.adj.cat.rds"))
in24_fi_t1.adj.cat.medoids <- readRDS(here("Data/processed/in24_fi_t1.adj.cat.medoids.rds"))

in24_fg_t1.adj.cat <- readRDS(here("Data/processed/in24_fg_t1.adj.cat.rds"))
...
ggsave(here("Plots/in24_adj_nutr_dist.png"), bg = "white", plot = in24_nutr_dist, width = 20, height = 13, dpi = 300)
...
# Save
write.xlsx(ds_in24_nutr_k, here("Excel files/test_IN24_NUTR_k.xlsx"), rowNames = TRUE)
...
# save
ggsave(here("Plots/in24_adj_ng_dist.png"), bg = "white", plot = in24_ng_dist, width = 15, height = 9, dpi = 300)
...
# Save
write.xlsx(ds_in24_ng_k, here("Excel files/test_IN24_NG_k.xlsx"), rowNames = TRUE)
...
fi_bar
 ...
 # save
ggsave(here("Plots/in24_fi_bar.png"), bg = "white", plot = fi_bar, width = 15, height = 9, dpi = 300)
...
# Save
write.xlsx(preferred_oil_df, here("Excel files/test_preferred_oil_k.xlsx"), rowNames = F)
write.xlsx(fi_df, here("/Excel files/test_IN24_FI_k.xlsx"), rowNames = F)
...
# save
ggsave(here("Plots/in24_fg_bar.png"), bg = "white", plot = fg_bar, width = 10, height = 6, dpi = 300)
...
# save
write.xlsx(fg_df, here("Excel files/fg_CAT_test_HEI.xlsx"), rowNames = F)
...
write.xlsx(ds_in24_fg_proc_k, here("Excel files/ds_in24_fg_proc_k.xlsx"), rowNames = T)
