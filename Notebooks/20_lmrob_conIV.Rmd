...
# save excel
write.xlsx(lmrob_l6_df, here("Excel files/lmrob_l6_cont.xlsx"), rowNames = T)
...
# save excel
write.xlsx(lmrob_l6.hei_df, here("Excel files/lmrob_l6.hei_cont.xlsx"), rowNames = T)
...
# save
ggsave(here("Plots/distr_anx_l6_con.png"), bg = "white", plot = p, width = 12, height = 9, dpi = 300) 
...
ggsave(here("Plots/scatterplot_l6_con.png"), bg = "white", plot = p2.2, width = 12, height = 9, dpi = 300) 
...
ggsave(here("Plots/lmrob_l6_hv.png"), bg = "white", plot = lmrob_l6_hv, width = 10, height = 6, dpi = 300)
...
ggsave(here("Plots/lmrob_l6_hw.png"), bg = "white", plot = lmrob_l6_hw, width = 10, height = 6, dpi = 300)
...
ggsave(here("Plots/lmrob_l6_resw.png"), bg = "white", plot = lmrob_l6_resw, width = 10, height = 6, dpi = 300)
...
ggsave(here("Plots/lmrob_l6_har_res.png"), bg = "white", plot = lmrob_l6_har_res, width = 10, height = 6, dpi = 300)
...
# save excel
write.xlsx(lmrob_gbm_df, here("Excel files/lmrob_gbm_cont.xlsx"), rowNames = T)
...
# save rds
saveRDS(df_gbm, here("Data/Processed/df_gbm.rds"))
saveRDS(tse_count, here("Processed/tse_gbm_count.rds"))
...
# save excel
write.xlsx(lmrob_gbm.hei_df, here("Excel files/lmrob_gbm.hei_cont.xlsx", rowNames = T))
...
# save
ggsave(here("Plots/distr_anx_gbm_con.png"), bg = "white", plot = p, width = 8, height = 6, dpi = 300) 
...
ggsave(here("Plots/scatterplot_gbm_con.png"), bg = "white", plot = p2.2, width = 8, height = 4, dpi = 300)
