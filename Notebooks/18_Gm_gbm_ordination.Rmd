...
tse_ko <- readRDS(here("Data/Processed/tse_ko.rds"))
...
ggsave(here("Plots/MDS_gbm_aitchison.png"), bg = "white", plot = MDS_p, width = 13, height = 15, dpi = 300)
...
ggsave(here("Plots/MDS_ko_aitchison.png"), bg = "white", plot = MDS_p, width = 20, height = 25, dpi = 300)
