...
# taxa, species # speficy your own path
...
# taxa, phylum # specify your ouw path
...
# save for inclusion in supp
write.xlsx(gm_taxa_spec_t1, "C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/DMA_T1_taxa/Abundance/MGS.matL6.xlsx",  rowNames = TRUE)
...
saveRDS(gm_taxa_spec_t1.f, here("Data/Processed/gm_taxa_spec_t1.f.rds"))
saveRDS(gm_taxa_spec_t1, here("Data/Processed/gm_taxa_spec_t1.rds"))
...
# save for inclusion in supp
write.xlsx(gm_taxa_pyl_t1, "C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/DMA_T1_taxa/Abundance/MGS.matL1.xlsx", rowNames = TRUE)
...
saveRDS(gm_taxa_pyl_t1.f, here("Data/Processed/gm_taxa_pyl_t1.f.rds"))
...
write.xlsx(gm_ko_t1, "C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/DMA_T1_Funct/KGML0.xlsx", rowNames = TRUE)
...
saveRDS(gm_ko_t1.raw, here("Data/Processed/gm_ko_t1.raw.rds"))
saveRDS(gm_ko_t1.f, here("/Data/Processed/gm_ko_t1.f.rds"))
