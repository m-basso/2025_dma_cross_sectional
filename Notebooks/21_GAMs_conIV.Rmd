...
# save excel
write.xlsx(gam_gbm_df, "C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/Workspace.1/Excel files/gam_gbm_cont.xlsx", rowNames = T)
...
# save excel
write.xlsx(gam_gbm.hei_df, "C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/Workspace.1/Excel files/gam_gbn.hei_cont.xlsx", rowNames = T)
...
p <- draw(gam_adj, select = 1) +
    labs(x = "Inositol synthesis (Clr- abundance)", y = "Residualsed STAI-s", title = NULL) +
    geom_point(
      data = df_gbm,
...
ggsave("C:/Users/bm00900/OneDrive - University of Surrey/Desktop/Ph.D/DMA study/Data/Workspace.1/Plots/plot_inositol.png", bg = "white", plot = p
